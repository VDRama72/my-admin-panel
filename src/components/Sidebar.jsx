...
export default function Sidebar() {
  ...
  const linkClass = "hover:underline px-2 py-1 rounded text-sm";
  const activeClass = "bg-indigo-100 font-semibold";

  return (
    <aside className="w-full sm:w-64 bg-white shadow p-4 sm:h-screen sm:overflow-y-auto">
      <h2 className="text-lg sm:text-xl font-bold mb-4 text-blue-700">🛠️ Admin Panel</h2>
      <nav className="flex flex-wrap sm:flex-col gap-2 text-blue-700 text-sm">
