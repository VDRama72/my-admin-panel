...
export default function Sidebar() {
  ...
  return (
    <aside className="w-full sm:w-64 bg-white shadow p-4">
      <h2 className="text-xl font-bold mb-4 text-blue-700">🛠️ Admin Panel</h2>
      <nav className="grid grid-cols-2 sm:flex sm:flex-col gap-2 text-blue-700 text-sm sm:text-base">
        ...
        <Link to="/dashboard/admin/cs" className={`${linkClass} ${location.pathname === '/dashboard/admin/cs' ? activeClass : ''}`}>☎️ CS</Link>
        <Link to="/dashboard/admin/promo" className={`${linkClass} ${location.pathname === '/dashboard/admin/promo' ? activeClass : ''}`}>🎁 Promo</Link>
